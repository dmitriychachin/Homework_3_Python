...
def calculate_word_cost(word, alphabet):
...
alphabet = {
    'A': 1, 'E': 1, 'I': 1, 'O': 1, 'U': 1, 
    'L': 1, 'N': 1, 'S': 1, 'T': 1, 'R': 1, 'А': 1, 'В': 1, 'Е': 1, 'И': 1, 'Н': 1, 'О': 1, 'Р': 1, 'С': 1, 'Т': 1,
...
if any(char.isalpha() for char in word):
    cost = calculate_word_cost(word, alphabet)
    print(f"The cost of the word '{word}' in English alphabet is: {cost}")
else:
